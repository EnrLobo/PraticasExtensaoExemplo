...
function loadGoogleSheetData() {
    ...
    const spreadsheetId = '1TCw7yapGqN8NywBvjpFrR1NJxXMzpR8QxFtAe18IcSo';
    // ID da planilha dentro do documento (geralmente 0 para a primeira planilha)
    const sheetId = 0;

    gapi.client.sheets.spreadsheets.values.get({
        spreadsheetId: spreadsheetId,
        range: 'acoesIPCSJM' // Substitua pelo nome da aba que você deseja ler
...
function initGoogleSheetsApi() {
    gapi.client.init({
        apiKey: 'AIzaSyAAgt9emyz_I22-kfPQXd0FNie5L6ZD8zM',
